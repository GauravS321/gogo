...
/**
 * @author : DJ
 * @description : This function imports blockchain address to blockchain node.
...
exports.importaddress = (primechain_address) => {
    return new Promise(async function (resolve, reject) {
        let blockchainparams = await bcSdk.importAddress({
