...
/**
 * @author : DJ
 * @description : This function creates targeted atomic offer
 * @property : PRIMECHAINTECH
 * */

var bcSdk = require('multichainsdk');

exports.create_targeted_offer = (from_address, to_address, ask_asset, offer_asset) => {
