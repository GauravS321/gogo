class MailNotificationEngine {
    ...
    sendEmailNotification(fromAddress, toList, subject, body, ccList, bccList) {
        return new Promise((resolve, reject) => {
            ...
            if (ccList && ccList.length) {
                ...
                if (ccEmail && ccEmail.length)
                    sgRequestedData['cc'] = ccEmail;
            }
            ...
            this.sgMail.send(sgRequestedData)
                .then(() => {
                    resolve(true);
                })
    ...
    *******************************************************************************************************************/
    sendPasswordResetEmail(email, username, token, url) {
        return new Promise((resolve, reject) => {
            ...
            let emailBody = `<p>Hello ${username}!
                            ...
                            <br>
                            ${this.baseUrl}/${url}/reset-password?email_address=${email}&random=${token}
                            </p>
    ...
    sendPasswordChangedNotification(email, username) {
        return new Promise((resolve, reject) => {
            ...
            let emailBody = `Hello ${username}!
                            ...
                            <a href='${this.baseUrl}/account/lost-password' style='padding: 8px 20px; background-color: #4B72FA; color: #fff; font-weight: bolder; font-size: 16px; display: inline-block; margin: 20px 0px; margin-right: 20px; text-decoration: none;'>Reset password
                            </a>
                            <br>`;
    ...
    shareVerificationMail(sender_email, receiver_name, email, path) {
        return new Promise((resolve, reject) => {
            ...
            let emailBody = `<h1 style="margin-top: 0px;">
                        ...
                        <a href='${this.baseUrl}/web/plugins/bank-guarantee/${path}' style='padding: 8px 20px; background-color: #4B72FA; color: #fff; font-weight: bolder; font-size: 16px; display: inline-block; margin: 20px 0px; margin-right: 20px; text-decoration: none;'>View document
                        </a>
                        <br>`;
...
module.exports = new MailNotificationEngine(process.env.SENDGRID_API_KEY, process.env.APPLICATION_NAME);
