    ...
    shareShopPermitsPrimeMasonMail(sender_email, receiver_name, email, use_case, path) {
        return new Promise((resolve, reject) => {
            ...
            let emailBody = `<p><strong>
                        ...
                        <a href='${this.baseUrl}/plugins/primemason/${use_case}/view-permits?${path}' style='padding: 8px 20px; background-color: #4B72FA; color: #fff; font-weight: bolder; font-size: 16px; display: inline-block; margin: 20px 0px; margin-right: 20px; text-decoration: none;'>View document</a>
